...
# multiverse_cov_plot_list <- cov_multiverse_adj_mat %>% map(~plot_network(adjmatrix = .x,
#                                                                          seed = 42))
...
# multiverse_cov_plot_list %>% map2(index, ~{

# pdf(paste0("analysis/figures/multiverse_nets_cov_",.y,".pdf"), width = 8, height = 5.75)
